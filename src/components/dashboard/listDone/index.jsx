        ...
        {done?.map((val, i) => {
          return (
            <div className="row col-12 border border-top-0 py-2 m-0 ">
              ...
              <div className="col-8 p-0 text-secondary my-auto">
                {val.title}
              </div>
              <div className="d-flex justify-content-center align-items-center col-3 p-0 text-secondary my-auto text-center">
                <div
                  onClick={() =>
                    handlePopUp({
                      id: val.id,
